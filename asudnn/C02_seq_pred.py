...
def pred_zone_seq(zone_data_test, att_index, n_output, x_test, y_test, zone_id, test_routes, net_para, tail_name, model, all_seq = False):
...
if __name__ == '__main__':
    ...
    for tail_name in test_list:
        ...
        if not SAMPLE:
            pred_zone_seq(zone_data_test, att_index, n_output, x_test, y_test, zone_id, test_routes, net_para, tail_name, model, all_seq)
