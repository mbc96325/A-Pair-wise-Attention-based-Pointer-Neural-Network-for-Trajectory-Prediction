...
from lstm_encoder_decoder import Encoder, Decoder, lstm_encoder_decoder
...
if __name__ == '__main__':
    model_name = 'lstm_en_de_rand_seq'
    ...
    decoder = Decoder(embedding_dim=num_features_without_zone, hidden_size=HIDDEN_SIZE)
    ptr_net = lstm_encoder_decoder(encoder, decoder, num_zone_id_feature=len(zone_id_feature), input_seq_dict=input_seq_dict,
